...
namespace InLifeCMS.ViewModel
{
    ...
    {
        [Key]
        public int intHeroId { get; set; }
        public string strHeroBg { get; set; }
        [Required(ErrorMessage = "Title is required!!!")]
        public string strHeroTitle { get; set; }
        [Required(ErrorMessage = "Button Text is required!!!")]
        public string strHeroBtnTxt { get; set; }
        ...
        public string strHeroMobBg { get; set; }
