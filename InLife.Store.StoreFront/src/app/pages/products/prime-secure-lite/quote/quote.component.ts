...
export class QuoteComponent implements OnInit, OnDestroy
{
	...
	saveQuoteForm(isEligible: boolean)
	{
		...
		var dataInternalAPI: any =
		{
			...
			customerBirthdate: formatDate(new Date(calcInfo.get('dateofbirth').value), 'yyyy-MM-dd', 'en-US', 'Asia/Manila'),
		...
		var dataExternalAPI = {
			...
			InsuredBirthday: formatDate(new Date(calcInfo.get('dateofbirth').value), 'MM/dd/yyyy', 'en-US', 'Asia/Manila'),
