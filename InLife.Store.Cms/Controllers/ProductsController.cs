	...
	public class ProductsController : BaseController
	{
		...
		public ActionResult Details(int? id)
		{
			try
			{
				...
				var model = productRepository.GetAll().SingleOrDefault(x => x.Id == id);
		...
		public ActionResult Create([Bind("ProductImg, ProductName, ProductPrice, ProductCode, ShortDescription, PriceWithOffer, SortNum")] ProductViewModel viewModel)
		{
			...
			try
			{
				...
				LogUserActivity("Created a Product", $"Created a new Product - {model.ProductName}");
		...
		public ActionResult Edit(int id, [Bind("ProductImg, ProductName, ProductPrice, ProductCode, ShortDescription, PriceWithOffer, SortNum")] ProductViewModel viewModel)
		{
			...
			try
			{
				...
				LogUserActivity("Updated a Product", $"Product '{model.ProductName}' [{model.Id}] has been updated.");
		...
		public ActionResult Delete(int id)
		{
			...
			try
			{
				...
				LogUserActivity("Deleted a Product", $"Product '{model.ProductName}' [{model.Id}] has been deleted.");
