...
export class PaymentFailedComponent implements OnInit {
  responseCode:any;
  text:any;
  constructor(private ngxService: NgxUiLoaderService,private routerlink: Router,private route: ActivatedRoute,public session: SessionStorageService, private http: HttpClient) {
